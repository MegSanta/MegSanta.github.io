...
function Home(props){
    ...
    return(
        <div>
            <h1>Megan's Website</h1>
            <body className='custom-text'>Nice to Meet You! I am a software engineering major. This is my website.</body>
            <img src={selfie} alt="selfie" className="custom-image" />
            {/* LinkedIn Button */}
            <div>
                <a href="https://www.linkedin.com/in/megan-santagata/" target="_blank" rel="noopener noreferrer">
                    <button className="small-button">
                        <img src={linkedin} alt="linkedin logo"/>
                    </button>
                </a>
                <a href="https://github.com/MegSanta/" target="_blank" rel="noopener noreferrer">
                    <button className="small-button">
            ...
            <div>
                <a href= "https://uxfol.io/p/4fd6ec7f/03d3353f" target="_blank" rel='noopener noreferrer'>
                    <button style={{ backgroundColor: 'lightblue', color: 'black' }}>Human Computer Interaction Project</button>
                </a>
            </div>
